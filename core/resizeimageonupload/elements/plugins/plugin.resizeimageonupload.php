 ...
 * Version: 1.1 (03.04.2013) fix some errors, add new parameter "exclude_dirs_suffix"
 * Version: 1.0 (01.04.2013) It`s must correctly work in ModX {REVO} 2.2 - 2.2.6
...
$config_default_src_param = str_replace("'","",$config_default_src_param);
$config_default_thumb_param = str_replace("'","",$config_default_thumb_param);
...
if ($exclude_dirs and $exclude_dirs=str_replace(' ', '', $exclude_dirs) and ($exclude_dirs=explode(",",$exclude_dirs))){
